...
export type AppCopy = {
  passwordVisibility: { show: string; hide: string };
  studio: {
    tagline: string;
    heroHint: string;
    liveLife: string;
  ...
  stars: {
    ...
    emptyFreeTitle: string;
    emptyFreeBody: string;
    emptyFreeCta: string;
    emptyProTitle: string;
    emptyProBody: string;
    refillsOn: string;
    dismiss: string;
    loadError: string;
  ...
  errors: {
    ...
    analysisVideoUnreadable: string;
...
const dictionary: Record<Locale, AppCopy> = {
  en: {
    ...
    studio: {
      ...
      ready: "Your keepers are ready.",
      analysingHint:
        "A little attention to every detail. You can stay right here.",
      oneStar: "1 analysis · 1 star",
      allPhotos: "All photos",
      proEyebrow: "A LITTLE MORE MOVID",
    },
    language: {
      label: "Language",
      english: "English",
    ...
    hero: {
      ...
      description:
        "Record 15 seconds or upload a longer clip and trim it — AI finds your 5 most shareable moments.",
    ...
    analysis: {
      ...
      steps: [
        "Reading pace and composition",
        "Finding energy shifts",
        "Spotting memorable peaks",
    ...
    results: {
      ...
      selectHint:
        "Check the moments you want, then download the real frames as JPEG.",
    ...
    camera: {
      ...
      maxHint: "{max}s max",
      permissionDenied:
        "We can’t reach your camera. Check that MoVid has camera and microphone permission, then try again.",
    },
    momentsEmpty: {
      title: "No moments yet",
      description:
        "Record or upload a video from Home and AI will find your best moments.",
      cta: "Go to Home",
    },
    library: {
      ...
      title: "Your moments",
      description:
        "Everything you've created in the last 30 days. Older videos are deleted automatically.",
      open: "Open",
      back: "All moments",
      delete: "Delete",
    ...
    pro: {
      ...
      perMonth: "/mo",
      compare: {
        videos: "Videos a week",
        moments: "Moments per video",
        length: "Clip length",
      },
      wasPrice: "€6.99",
      discount: "-43%",
    ...
    account: {
      ...
      upgradeSub:
        "{pro} videos a week, {moments} moments each, {seconds}s clips",
      deleteTitle: "Delete account",
      deleteBody:
        "Your profile, your videos and every moment you've saved are erased for good. This can't be undone.",
    ...
    stars: {
      ...
      emptyFreeBody:
        "Free accounts get {total} videos a week. Go Pro for {pro} a week and keep creating.",
      emptyFreeCta: "See Pro",
      emptyProTitle: "You’ve used all your stars",
      emptyProBody:
        "You’ve used your {total} videos for this week. They refill automatically.",
    ...
    errors: {
      ...
      analysisFailed:
        "Something went wrong analysing your video. Please try again later — no star was used.",
      analysisUnavailable:
        "AI analysis isn’t available right now (the server has no OpenAI key configured). No star was used.",
      planUnavailable:
        "We couldn’t check your weekly stars. Check your connection and try again — no star was used.",
      analysisVideoUnreadable:
        "We couldn’t read the frames of that recording. Try recording again — no star was used.",
      downloadFailed: "We couldn’t save those photos. Please try again.",
    },
    desktopGate: {
      title: "Open this on your phone",
      description:
        "MoVid is designed for mobile — please visit this page from your phone’s browser to record and analyse your video.",
    },
    auth: {
      login: {
      ...
      forgot: {
        ...
        sentSocialHint:
          "Signed up with Google or Apple? There’s no password to reset — go back and use that button instead.",
      },
      ...
      profile: {
        ...
        photoTooLarge:
          "That image is too large to open. Choose one under 30 MB.",
        ...
        noPasswordProvider:
          "You signed in with Google or Apple, so there’s no password to change here.",
      },
    },
  },
  es: {
    ...
    studio: {
      ...
      ready: "Estas merecen quedarse.",
      analysingHint: "Un poco de atención a cada detalle. Quédate por aquí.",
      oneStar: "1 análisis · 1 estrella",
      allPhotos: "Todas las fotos",
      proEyebrow: "UN POCO MÁS DE MOVID",
    },
    language: {
      label: "Idioma",
      english: "Inglés",
    ...
    hero: {
      ...
      description:
        "Graba 15 segundos o sube un clip más largo y recórtalo — la IA encuentra tus 5 instantes más compartibles.",
    ...
    review: {
      ...
      description:
        "Ahora vamos a encontrar las partes que merece la pena repetir.",
    ...
    analysis: {
      ...
      steps: [
        "Leyendo ritmo y composición",
        "Detectando cambios de energía",
        "Encontrando los picos memorables",
    ...
    results: {
      ...
      selectHint:
        "Marca los momentos que quieras y descarga los fotogramas reales en JPEG.",
    ...
    camera: {
      ...
      maxHint: "{max}s máx.",
      permissionDenied:
        "No podemos acceder a tu cámara. Comprueba que MoVid tiene permiso de cámara y micrófono, y vuelve a intentarlo.",
    },
    momentsEmpty: {
      title: "Aún no hay momentos",
      description:
        "Graba o sube un vídeo desde Inicio y la IA encontrará tus mejores momentos.",
      cta: "Ir a Inicio",
    },
    library: {
      ...
      title: "Tus momentos",
      description:
        "Todo lo que has creado en los últimos 30 días. Los vídeos más antiguos se borran automáticamente.",
      open: "Abrir",
    ...
    pro: {
      ...
      perMonth: "/mes",
      compare: {
        videos: "Vídeos por semana",
        moments: "Momentos por vídeo",
      ...
      unavailable:
        "Las suscripciones solo están disponibles en la app de MoVid para iOS.",
      noOffering:
        "Pro todavía no está a la venta — vuelve a intentarlo en un momento.",
    },
    account: {
      eyebrow: "TU CUENTA",
      title: "Cuenta",
      ...
      upgradeSub:
        "{pro} vídeos por semana, {moments} momentos y clips de {seconds}s",
      deleteTitle: "Eliminar cuenta",
      deleteBody:
        "Se borran para siempre tu perfil, tus vídeos y todos los momentos que hayas guardado. No se puede deshacer.",
    ...
    stars: {
      ...
      emptyFreeBody:
        "Las cuentas free tienen {total} vídeos por semana. Pasa a Pro para tener {pro} y seguir creando.",
      emptyFreeCta: "Ver Pro",
      emptyProTitle: "Has agotado tus estrellas",
      emptyProBody:
        "Ya has usado tus {total} vídeos de esta semana. Se recargan automáticamente.",
    ...
    errors: {
      ...
      analysisFailed:
        "Se ha producido un error al analizar tu vídeo. Vuelve a intentarlo más tarde — no se ha gastado ninguna estrella.",
      analysisUnavailable:
        "El análisis con IA no está disponible ahora mismo (el servidor no tiene configurada la clave de OpenAI). No se ha gastado ninguna estrella.",
      analysisVideoUnreadable:
        "No hemos podido leer los fotogramas de esa grabación. Prueba a grabar de nuevo — no se ha gastado ninguna estrella.",
      planUnavailable:
        "No pudimos comprobar tus estrellas semanales. Revisa tu conexión y vuelve a intentarlo — no se ha gastado ninguna estrella.",
      downloadFailed:
        "No hemos podido guardar esas fotos. Vuelve a intentarlo.",
    },
    desktopGate: {
      title: "Abrí esto desde tu teléfono",
      description:
        "MoVid está pensado para móvil — abrí esta página desde el navegador de tu teléfono para grabar y analizar tu vídeo.",
    },
    auth: {
      login: {
      ...
      forgot: {
        ...
        sentSocialHint:
          "¿Te registraste con Google o Apple? Entonces no hay contraseña que restablecer — vuelve atrás y entra con ese botón.",
      },
      ...
      profile: {
        ...
        photoTooLarge:
          "Esa imagen pesa demasiado para abrirla. Elige una de menos de 30 MB.",
        ...
        noPasswordProvider:
          "Iniciaste sesión con Google o Apple, así que aquí no hay contraseña que cambiar.",
      },
    },
  },
};
