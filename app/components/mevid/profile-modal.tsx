    ...
    >
      ...
      >
        <div className="mb-5 flex items-center gap-4">
          ...
          <button type="button" onClick={onClose} aria-label={t.close} className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-white/70 dark:bg-white/5 text-[#697061] dark:text-[#a6b0a3] hover:bg-white dark:hover:bg-white/15">
            <X size={20} />
          </button>
        </div>
